...
export const SoredIcon: React.FC<IconProps> = ({ className }) => (
...
export const ArrowDownOnSquareIcon: React.FC<IconProps> = ({ className }) => (
...
export const ShareIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 4.186m0-4.186c.206.054.418.1.637.143a2.25 2.25 0 011.637 1.637c.043.219.089.431.143.637m-2.274 1.909a2.25 2.25 0 003.182 0m-3.182 0c.206-.054.418-.1.637-.143a2.25 2.25 0 001.637-1.637c.043-.219.089-.431.143-.637m10.875 5.127a2.25 2.25 0 100-4.186m0 4.186c-.206-.054-.418-.1-.637-.143a2.25 2.25 0 01-1.637-1.637c-.043-.219-.089-.431-.143-.637m2.274-1.909a2.25 2.25 0 00-3.182 0m3.182 0c-.206.054-.418.1-.637.143a2.25 2.25 0 00-1.637 1.637c.043.219.089.431.143.637M12 12a2.25 2.25 0 100-4.186m0 4.186c.206-.054.418-.1.637-.143a2.25 2.25 0 001.637-1.637c.043-.219.089-.431.143-.637m-2.274-1.909a2.25 2.25 0 013.182 0m-3.182 0c.206.054.418.1.637.143a2.25 2.25 0 011.637 1.637c.043.219.089.431.143.637" /></svg>
);
...
export const FunnelIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.267-4.17.735L12 21.75l4.17-.735c-1.288-.468-2.7-.735-4.17-.735z" />
  </svg>
);
...
// Additional icons for toasts and UX
